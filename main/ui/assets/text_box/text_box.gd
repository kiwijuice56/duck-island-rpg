...
var icons := {
	...
	"yukid" : preload("res://main/ui/assets/text_box/icons/yukid.png")
}

var voices := {
	"mii_duck" : preload("res://main/ui/assets/text_box/voices/mii_duck.wav"),
	"yukid" : preload("res://main/ui/assets/text_box/voices/yukid.wav")
}
